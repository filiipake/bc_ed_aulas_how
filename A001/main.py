...
resultados = pd.DataFrame(counter.items(), columns=['Combinacao', 'Frequencia'])
resultados['p_freq'] = resultados['Frequencia']/resultados['Frequencia'].sum()
resultado = resultados.sort_values(by = 'p_freq')
